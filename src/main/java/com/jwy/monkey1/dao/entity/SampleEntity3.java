...
/**
 * <p>
 *     例子entity3: 继承{@link AbstractEntity} "ID"的命名以及生成策略可以自定义
 * </p>
 * <p>
 *     ！！非常不建议使用此策略，请优先选择{@link SampleEntity1} 或者{@link SampleEntity}对应的例子。
 *     如果有特殊需求需要经过技术评审后使用。
 * </p>
 * <p>
 ...
 * </p>
 * <p>
 *     {@link SampleEntity3}与{@link SampleEntity1}对应的例子基本相同（除开需要自己设置id值），
 *     请参考:
...
public class SampleEntity3 extends AbstractEntity{
